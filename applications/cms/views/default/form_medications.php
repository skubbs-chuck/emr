<div class="box no-border">
	<div class="box-body">
	    ...
	    <ul class="dropdown-menu scrollable-menu" role="menu">
	        <?php foreach ($medications['form_list'] as $form): ?>
...
<div id="result_medications">
	<div class="panel-group" id="consulatation_accordion">
	<?php foreach ($medications['forms'] as $form): $id = 'id_' . $form->tbl; ?>
		<div class="panel panel-default">
			...
			<div id="<?php echo $form->tbl . '_' . $form->$id ?>" class="panel-collapse collapse">
	            <div class="panel-body" form-tbl="<?php echo $form->name ?>" form-id="<?php echo $form->$id ?>" id="medications_data_<?php echo $form->$id ?>_<?php echo $form->tbl ?>"></div>
	        </div>
		</div>
	<?php endforeach ?>
	</div>
...
$(function(){
	$(document).ready(function(){
		$('div[id^="medications_data_"]').each(function(index) {
	...
	$(document).on('click', 'a[id^="create-new-note-form_"]', function() {
        ...
        ajaxPatient(form_to_create, 'result_medications');
        return false;
    });
});
</script>