        ...
        <?php foreach ($nurse_visit['forms'] as $form): $id = 'id_' . $form->tbl; ?>
            ...
            <div id="wrap-nurse_visit-<?php echo $wrap ?>" class="panel panel-default">
                <div class="panel-heading">
                    <a data-toggle="collapse" data-parent="#accordion" href="#nurse_visit-<?php echo $wrap ?>">
                ...
                <div id="nurse_visit-<?php echo $wrap ?>" class="panel-collapse collapse skubbs_result"></div>
