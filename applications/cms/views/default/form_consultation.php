		...
		<div class="btn-group pull-right">
		    ...
		    <ul class="dropdown-menu scrollable-menu" data-toggle="dropdown" role="menu">
		        <?php foreach ($consultation['form_list'] as $form): ?>
		        	<li><a href="#" class="skubbs_ajax" s-wrap="consultation" s-request="<?php echo $form->table_name ?>" s-action="create"><?php echo $form->name ?></a></li>
		        <?php endforeach ?>
		    </ul>
		</div>
	</div>
    	...
    	<?php foreach ($consultation['forms'] as $form): $id = 'id_' . $form->tbl; ?>
    		...
    		<div id="wrap-consultation-<?php echo $wrap ?>" class="panel panel-default">
    			<div class="panel-heading">
    	            <a data-toggle="collapse" data-parent="#accordion" href="#consultation-<?php echo $wrap ?>">
    			...
    			<div id="consultation-<?php echo $wrap ?>" class="panel-collapse collapse skubbs_result"></div>
