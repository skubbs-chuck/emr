<div id="consultation_vars" style="display:none">
	<input type="hidden" id="consultation_var-id_patient" value="<?php echo $consultation['id_patient'] ?>">
	<input type="hidden" id="consultation_var-id_form" value="<?php echo $consultation['id_form'] ?>">
</div>
<div class="box no-border">
	<div class="box-body">
		<div class="btn-group pull-right" id="create_new_notes-consultation">
		    ...
		    <ul class="dropdown-menu scrollable-menu" data-toggle="dropdown" role="menu">
		        <?php foreach ($consultation['form_list'] as $form): ?>
		        	<li><a href="#" id="create_new_notes-consultation-<?php echo $form->table_name ?>"><?php echo $form->name ?></a></li>
		        <?php endforeach ?>
		    </ul>
		</div>
	</div>
	...
	<?php foreach ($consultation['forms'] as $form): $id = 'id_' . $form->tbl; ?>
		<div class="panel panel-default">
			<div class="panel-heading">
	            <a data-toggle="collapse" data-parent="#consultation_accordion" href="#<?php echo $form->tbl . '_' . $form->$id ?>">
