<div id="notes_consultation" class="box no-border">
    <div class="box-body">
    ...
    <div class="box no-border flat skubbs_result">
        <div class="panel-group" id="notes_consultation_accordion">
        ...
        <?php foreach ($consultation['forms'] as $form): $id = 'id_' . $form->tbl; ?>
            ...
            <div id="wrap-notes_consultation-<?php echo $wrap ?>" class="panel panel-default">
                ...
                <div id="notes_consultation-<?php echo $wrap ?>" class="panel-collapse collapse skubbs_result"><div class="text-center">Rendering Data...</div></div>
