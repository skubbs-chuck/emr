<div id="other" class="box no-border">
        ...
        <div class="btn-group pull-right">
            ...
            <ul class="dropdown-menu scrollable-menu" data-toggle="dropdown" role="menu">
                <?php foreach ($other['form_list'] as $form): ?>
                    <li><a href="#" class="skubbs_ajax" s-wrap="other" s-request="<?php echo $form->table_name ?>" s-action="create"><?php echo $form->name ?></a></li>
                <?php endforeach ?>
            </ul>
        </div>
    </div>
    <div class="box no-border flat skubbs_result">
        ...
        <?php foreach ($other['forms'] as $form): $id = 'id_' . $form->tbl; ?>
            ...
            <div id="wrap-other-<?php echo $wrap ?>" s-request="<?php echo $form->tbl ?>" s-form-id="<?php echo $id ?>" s-wrap="wrap-other-<?php echo $wrap ?>" class="panel panel-default skubbs_ajax">
