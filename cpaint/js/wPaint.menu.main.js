(function ($) {
  ...
  $.fn.wPaint.menus.main = {
    img: base_url + 'img/icons-menu-main.png',
    items: {
      undo: {
        icon: 'generic',
        title: 'Undo',
        index: 0,
        img: base_url + 'cpaint_icons/icon_undo.png',
      ...
      redo: {
        ...
        title: 'Redo',
        index: 0,
        img: base_url + 'cpaint_icons/icon_redo.png',
      ...
      clear: {
        ...
        title: 'Clear',
        index: 0,
        img: base_url + 'cpaint_icons/icon_clear.png',
      ...
      rectangle: {
        ...
        title: 'Rectangle',
        index: 0,
        img: base_url + 'cpaint_icons/icon_rectangle.png',
      ...
      ellipse: {
        ...
        title: 'Ellipse',
        index: 0,
        img: base_url + 'cpaint_icons/icon_ellipse.png',
      ...
      line: {
        ...
        title: 'Line',
        index: 0,
        img: base_url + 'cpaint_icons/icon_line.png',
      ...
      pencil: {
        ...
        title: 'Pencil',
        index: 0,
        img: base_url + 'cpaint_icons/icon_pencil.png',
      ...
      eraser: {
        ...
        title: 'Eraser',
        index: 0,
        img: base_url + 'cpaint_icons/icon_eraser.png',
      ...
      bucket: {
        ...
        title: 'Bucket',
        index: 0,
        img: base_url + 'cpaint_icons/icon_fill.png',
  ...
  $.extend($.fn.wPaint.cursors, {
    'default': {path: base_url + 'img/cursor-crosshair.png', left: 7, top: 7},
    dropper:   {path: base_url + 'img/cursor-dropper.png', left: 0, top: 12},
    pencil:    {path: base_url + 'img/cursor-pencil.png', left: 0, top: 11.99},
    bucket:    {path: base_url + 'img/cursor-bucket.png', left: 0, top: 10},
    eraser1:   {path: base_url + 'img/cursor-eraser1.png', left: 1, top: 1},
    eraser2:   {path: base_url + 'img/cursor-eraser2.png', left: 2, top: 2},
    eraser3:   {path: base_url + 'img/cursor-eraser3.png', left: 2, top: 2},
    eraser4:   {path: base_url + 'img/cursor-eraser4.png', left: 3, top: 3},
    eraser5:   {path: base_url + 'img/cursor-eraser5.png', left: 3, top: 3},
    eraser6:   {path: base_url + 'img/cursor-eraser6.png', left: 4, top: 4},
    eraser7:   {path: base_url + 'img/cursor-eraser7.png', left: 4, top: 4},
    eraser8:   {path: base_url + 'img/cursor-eraser8.png', left: 5, top: 5 },
    eraser9:   {path: base_url + 'img/cursor-eraser9.png', left: 5, top: 5},
    eraser10:  {path: base_url + 'img/cursor-eraser10.png', left: 6, top: 6}
  });
